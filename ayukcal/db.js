...
const SEED_DB = [
  ...
  ["Ajiaco Santafereño", "Plato", "Casero", 100, 95, 5.5, 8, 4.5],
  ["Sancocho de Pollo", "Plato", "Casero", 100, 85, 7, 6, 3.5],
  ["Sancocho de Res", "Plato", "Casero", 100, 105, 7, 7, 5],
  ["Sancocho de Pescado", "Plato", "Casero", 100, 80, 8, 5, 2.5],
  ["Bandeja Paisa (promedio)", "Plato", "Referencia", 100, 210, 9, 18, 11],
  ["Tamal de Pollo", "Plato", "Casero", 100, 190, 8, 22, 8],
  ["Tamal Tolimense", "Plato", "Casero", 100, 205, 8, 23, 9],
  ["Changua", "Plato", "Casero", 100, 55, 4, 3, 3],
  ["Caldo de Costilla", "Plato", "Casero", 250, 130, 11, 5, 7],
  ["Carne Asada", "Proteína", "Referencia", 100, 190, 27, 0, 9],
  ["Carne de Cerdo Asada", "Proteína", "Referencia", 100, 220, 27, 0, 12],
  ["Pechuga de Pollo Cocida sin Piel", "Proteína", "Referencia", 100, 165, 31, 0, 3.6],
  ["Pollo Asado con Piel", "Proteína", "Referencia", 100, 215, 27, 0, 12],
  ["Hígado de Res Cocido", "Proteína", "Referencia", 100, 191, 29, 5, 5],
  ["Mojarra Frita", "Proteína", "Referencia", 100, 190, 22, 5, 9],
  ["Trucha", "Proteína", "Referencia", 100, 148, 21, 0, 6.5],
  ["Sardinas en Salsa de Tomate", "Proteína", "Referencia", 100, 185, 21, 4, 9],
  ["Camarón Cocido", "Proteína", "Referencia", 100, 99, 24, 0.2, 0.3],
  ["Frijol Rojo Cocido", "Carbohidrato", "Referencia", 100, 127, 8.7, 22.8, 0.5],
  ["Frijol Negro Cocido", "Carbohidrato", "Referencia", 100, 132, 8.9, 23.7, 0.5],
  ["Quinua Cocida", "Carbohidrato", "Referencia", 100, 120, 4.4, 21.3, 1.9],
  ["Avena Cocida en Agua", "Carbohidrato", "Referencia", 100, 71, 2.5, 12, 1.5],
  ["Harina de Maíz Precocida", "Carbohidrato", "Referencia", 100, 365, 6.5, 80, 2.5],
  ["Arepa de Maíz con Queso", "Plato", "Referencia", 100, 245, 7, 34, 9],
  ["Arepa de Huevo", "Plato", "Referencia", 100, 300, 9, 30, 16],
  ["Empanada de Carne", "Plato", "Referencia", 100, 260, 9, 28, 12],
  ["Empanada de Pollo", "Plato", "Referencia", 100, 250, 10, 27, 11],
  ["Pan de Bono", "Panadería", "Referencia", 100, 330, 8, 43, 14],
  ["Pandebono", "Panadería", "Referencia", 60, 198, 4.8, 25.8, 8.4],
  ["Buñuelo", "Panadería", "Referencia", 60, 190, 4, 22, 9],
  ["Almojábana", "Panadería", "Referencia", 60, 180, 5, 23, 7],
  ["Pan de Yuca", "Panadería", "Referencia", 60, 175, 3, 22, 8],
  ["Granola", "Carbohidrato", "Referencia", 30, 135, 3, 20, 5],
  ["Cereal de Maíz", "Carbohidrato", "Referencia", 30, 112, 2, 25, 0.3],
  ["Mantequilla de Maní", "Grasa", "Referencia", 16, 95, 4, 3.5, 8],
  ["Semillas de Girasol", "Grasa", "Referencia", 30, 175, 6, 6, 15.5],
  ["Semillas de Calabaza", "Grasa", "Referencia", 30, 168, 9, 4, 14.5],
  ["Aceite de Oliva", "Grasa", "Referencia", 15, 119, 0, 0, 13.5],
  ["Mayonesa", "Grasa", "Referencia", 15, 102, 0.2, 0.2, 11.3],
  ["Salsa de Tomate", "Condimento", "Referencia", 15, 17, 0.2, 4, 0],
  ["Mostaza", "Condimento", "Referencia", 15, 10, 0.6, 0.6, 0.6],
  ["Azúcar Blanca", "Dulce", "Referencia", 10, 39, 0, 10, 0],
  ["Miel", "Dulce", "Referencia", 21, 64, 0.1, 17.3, 0],
  ["Arequipe / Dulce de Leche", "Dulce", "Referencia", 30, 95, 2, 16, 2.5],
  ["Chocolate Negro 70%", "Dulce", "Referencia", 20, 120, 1.6, 9, 8.5],
  ["Palomitas de Maíz Caseras", "Snack", "Referencia", 30, 115, 3, 18, 4],
  ["Papas Fritas de Paquete (Referencia)", "Snack", "Referencia", 30, 160, 2, 16, 10],
  ["Plátano Maduro Frito", "Carbohidrato", "Referencia", 100, 220, 1.5, 34, 9],
  ["Plátano Verde Frito", "Carbohidrato", "Referencia", 100, 230, 1.5, 35, 9],
  ["Ñame Cocido", "Carbohidrato", "Referencia", 100, 118, 1.5, 27.9, 0.2],
  ["Arracacha Cocida", "Carbohidrato", "Referencia", 100, 99, 1.2, 23.9, 0.2],
  ["Guineo Verde Cocido", "Carbohidrato", "Referencia", 100, 122, 1.3, 32, 0.4],
  ["Mango Maduro", "Fruta", "Referencia", 100, 60, 0.8, 15, 0.4],
  ["Feijoa", "Fruta", "Referencia", 100, 50, 1, 13, 0.2],
  ["Uchuva", "Fruta", "Referencia", 100, 53, 1.9, 11.2, 0.7],
  ["Borojó", "Fruta", "Referencia", 100, 93, 1.5, 23, 0.5],
  ["Arazá", "Fruta", "Referencia", 100, 39, 1, 9, 0.3],
  ["Repollo", "Verdura", "Referencia", 100, 25, 1.3, 6, 0.1],
  ["Berenjena", "Verdura", "Referencia", 100, 25, 1, 6, 0.2],
  ["Espárragos", "Verdura", "Referencia", 100, 20, 2.2, 3.9, 0.1],
  ["Remolacha Cocida", "Verdura", "Referencia", 100, 44, 1.7, 10, 0.2],
  ["Brócoli Cocido", "Verdura", "Referencia", 100, 35, 2.4, 7.2, 0.4],
  ["Coliflor Cocida", "Verdura", "Referencia", 100, 23, 1.8, 4.1, 0.5],
  ["Espinaca Cocida", "Verdura", "Referencia", 100, 23, 3, 3.8, 0.3],
  ["Yogur Natural", "Lácteo", "Referencia", 170, 104, 5.9, 7.9, 5.7],
  ["Queso Mozzarella Porción", "Lácteo", "Referencia", 30, 84, 7.2, 0.7, 6.4],
  ["Queso Campesino Porción", "Lácteo", "Referencia", 30, 84, 5.4, 0.9, 6.6],
  ["Huevo Revuelto sin Aceite", "Proteína", "Referencia", 100, 149, 10, 1.6, 11],
  ["Café Negro sin Azúcar", "Bebida", "Referencia", 240, 2, 0.3, 0, 0],
  ["Té sin Azúcar", "Bebida", "Referencia", 240, 2, 0, 0.4, 0],
  ["Agua de Panela", "Bebida", "Referencia", 240, 90, 0, 23, 0],
  ["Jugo de Naranja", "Bebida", "Referencia", 240, 112, 1.7, 25.7, 0.4],
  ["Jugo de Mora", "Bebida", "Referencia", 240, 100, 0.8, 24, 0.3]
];
